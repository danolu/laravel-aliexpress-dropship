    ...
    public function create(array $data)
    {
        ...
        try {
            ...
            if (! is_null(core()->getConfigData('dropship.settings.product_price.price'))) {
                ...
                if (
                    core()->getConfigData('dropship.settings.product_price.price') == 2
                    ...
                    core()->getConfigData('dropship.settings.product_price.price') == 3
                    ...
                    core()->getConfigData('dropship.settings.product_price.price') == 4
